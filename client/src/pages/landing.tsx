...
export default function Landing() {
  ...
  const testimonials = [
    {
      ...
      comment:
        "Solaspec made the entire process seamless. The escrow protection gave me peace of mind, and the installer they matched me with was professional and efficient. My energy bill dropped by 90%!",
      image:
    ...
    },
    {
      ...
      location: "Austin, TX",
      comment:
        "As a business owner, I needed a reliable solar solution. The commercial system I purchased through Solaspec has exceeded expectations. ROI was achieved in just 5 years!",
      image:
    ...
    },
    {
      ...
      location: "Denver, CO",
      comment:
        "The installment payment option made solar accessible for our family. The platform's transparency and the quality of vendors exceeded our expectations. Highly recommend!",
      image:
  ...
  return (
    <div className="min-h-screen bg-background">
            ...
            <div className="animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="solar-border solar-text hover:bg-accent"
                >
                  Find Installers
                </Button>
              </div>
        ...
        <div className="max-w-7xl mx-auto container-mobile">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground">
              Top-rated systems from verified vendors
            </p>
          </div>
              ...
              >
                ...
                <CardContent className="p-6">
                  ...
                  <p className="text-foreground mb-4">
                    Complete {product.capacity} system with high-efficiency
                    panels and warranty.
                  </p>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="text-sm text-muted-foreground">
                      ...
                      {product.installments} (30 months)
                    </div>
      ...
      <section className="py-16 bg-muted/30">
        <div className="max-w-7xl mx-auto container-mobile">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Simple, secure, and transparent solar purchasing
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Explore verified solar systems from certified vendors with detailed specifications and reviews.",
              },
              {
                step: "2",
                title: "Secure Purchase",
                description:
                  "Pay securely with escrow protection. Choose full payment or flexible installment plans.",
              },
              {
                step: "3",
                title: "Find Installers",
                description:
                  "Get matched with certified installers in your area. View profiles, reviews, and availability.",
              },
              {
                step: "4",
                title: "Installation & Support",
                description:
                  "Professional installation with warranty support. Track progress and manage your system.",
              },
            ].map((item, index) => (
              <div
                key={item.step}
            ...
            {[
              {
                ...
                description:
                  "Military-grade encryption protects all data transfers",
              },
              {
                icon: CheckCircle,
              ...
              {[
                {
                  ...
                  description:
                    "Your payment is held securely until installation is complete and approved. Funds are only released when you're satisfied.",
                  color: "green",
                },
                {
                  icon: Users,
                  ...
                  description:
                    "Pay in full or choose installment plans. We support Paystack, cards, bank transfers, and digital wallets.",
                  color: "blue",
                },
                {
                  icon: Clock,
                  ...
                  description:
                    "Spread payments over 24-84 months with competitive rates. No hidden fees, transparent pricing.",
                  color: "yellow",
                },
              ].map((feature, index) => (
                <div
                ...
                <Card className="p-4 bg-card border">
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-xl font-bold solar-text">
                        $417/month
                      </span>
                    </div>
                  </div>
      ...
      <section className="py-16 bg-muted/30">
        <div className="max-w-7xl mx-auto container-mobile">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground">
              Real experiences from satisfied solar system owners
            </p>
          </div>
      ...
      {/* CTA Section */}
      <section className="py-10 solar-bg">
        <div className="max-w-7xl mx-auto container-mobile text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            ...
            clean, affordable solar energy with Solaspec's trusted platform.
          </p>
