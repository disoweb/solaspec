    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="flex space-x-4">
                <span className="text-gray-300 hover:text-white transition-colors" title="Visa">
                  <VisaIcon />
                </span>
                <span className="text-gray-300 hover:text-white transition-colors" title="Mastercard">
                  <MastercardIcon />
                </span>
                <span className="text-gray-300 hover:text-white transition-colors" title="PayPal">
                  <PayPalIcon />
                </span>
                <span className="text-gray-300 hover:text-white transition-colors" title="Bank Transfer">
                  <Landmark className="w-6 h-6" />
                </span>
                <span className="text-gray-300 hover:text-white transition-colors" title="Escrow">
            ...
            <div className="border-l border-r border-gray-700 px-6">
              ...
              <p className="mt-2 text-sm text-gray-400 italic">
                "Solaspec's escrow protection gave me peace of mind during my solar installation."
              </p>
            </div>
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Connecting verified solar vendors with customers nationwide through secure escrow protection.
            </p>
            <div className="flex space-x-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <Link href="/marketplace" className="text-muted-foreground hover:text-foreground transition-colors flex items-center">
              ...
              <li>
                <Link href="/installers" className="hover:text-white transition-colors flex items-center">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <a href="/api/login" className="hover:text-white transition-colors flex items-center">
                  <Landmark className="w-4 h-4 mr-2" /> Sell on Solaspec
                </a>
              </li>
              <li>
                <Link href="/vendor-dashboard" className="hover:text-white transition-colors flex items-center">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">&copy; {new Date().getFullYear()} Solaspec. All rights reserved.</p>
